...
1. Add the service to the `hawiyat-network`.
...
2. `traefik.http.routers.<UNIQUE-RULE>.rule=Host('your-domain.hawiyat.com')` Specifies the domain for the service
...
If you have any further questions or need assistance, join our [Discord server](https://discord.com/) and we'll be happy to help.
