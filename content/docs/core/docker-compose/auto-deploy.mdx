---
title: Auto-deploy
description: How to auto-deploy your docker-compose application with Hawiyat
---

Automatically deploying your docker-compose application to Hawiyat can be achieved through two primary methods: using Webhooks or the Hawiyat API. Each method supports various platforms and provides a streamlined deployment process.
