---
title: Overview
description: 'Explore the comprehensive monitoring features in Hawiyat for tracking the performance of applications, databases, and server resources.'
---


Hawiyat includes a robust monitoring system designed to give you real-time insights into your applications, databases, and server performance.
...
- **Historical Data**: For applications or databases that are not currently running, Hawiyat displays the last recorded metrics.
...
These monitoring tools in Hawiyat provide essential data that helps you manage resources effectively, ensuring optimal performance of your server and hosted applications.