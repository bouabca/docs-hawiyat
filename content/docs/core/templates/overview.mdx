---
title: Templates
description: Deploy open source templates with Hawiyat
---
...
We accept contributions to upload new templates to the Hawiyat repository.

Make sure to follow the guidelines for creating a template:

[Steps to create your own template](https://github.com/Hawiyat/Hawiyat/blob/canary/CONTRIBUTING.md#templates)