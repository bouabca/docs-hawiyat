---
title: Hawiyat API
description: Endpoints for hawiyat
full: true
---
...
<APIInfo method={"GET"} route={"/settings.getHawiyatVersion"}>

## settings-getHawiyatVersion
...
```bash
curl -X GET "http://localhost:3000/settings.getHawiyatVersion"
```
...
```js
fetch("http://localhost:3000/settings.getHawiyatVersion", {
  method: "GET"
});
```
