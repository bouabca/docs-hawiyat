---
title: 'Architecture of Hawiyat'
description: 'Overview of the core architecture components of Hawiyat.'
---

Understanding the architecture of Hawiyat is crucial for both deploying and scaling applications. Below is a diagram illustrating the core components:
...
When Hawiyat is installed, it automatically sets up the following components:
...
2. **PostgreSQL Database**: Acts as the primary database for Hawiyat, chosen for its robustness and widespread adoption. It stores all the configuration and operational data.
