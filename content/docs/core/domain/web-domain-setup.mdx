...
description: "Learn how to setup a main domain for the Hawiyat panel"
---

This guide covers the basic setup of a main domain for your Hawiyat panel.
...
4. Save the record. Your DNS record will be `canary.hawiyat.org`.
...
1. Log in to your Hawiyat panel.
2. Navigate to `/dashboard/settings/server`.
3. Under Server domain, set your domain to match the one configured in Cloudflare (e.g., `canary.hawiyat.org`).
4. Choose your certificate option:
   - `None`
   - `Let's Encrypt`
6. Access your panel via `https://canary.hawiyat.org`.
...
<ImageZoom src="/assets/images/web-domain-setup/hawiyat-setup.png" width={800} height={630} quality={100} priority alt='home og image' className="rounded-lg" />
