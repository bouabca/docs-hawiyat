...
4. Save the record. Your DNS record will be `canary.hawiyat.com`.
...
3. Under Server domain, set your domain to match the one configured in Cloudflare (e.g., `canary.hawiyat.com`).
4. Choose your certificate option:
   - `None`
   - `Let's Encrypt`
6. Access your panel via `https://canary.hawiyat.com`.
