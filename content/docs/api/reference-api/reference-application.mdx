...
description: Comprehensive documentation for Hawiyat's application management and deployment endpoints
full: true
---
...
# Application Management API Reference

## Overview

The Application Management API provides enterprise-grade endpoints for creating, managing, and deploying applications within the Hawiyat platform. These endpoints handle application lifecycle management, configuration, and deployment orchestration.
...
- Deployment endpoints: 20 requests/minute
- Build operations: 10 requests/minute
- Configuration updates: 50 requests/minute
...
```typescript
{
  ...
  issues?: {         // Optional detailed error information
